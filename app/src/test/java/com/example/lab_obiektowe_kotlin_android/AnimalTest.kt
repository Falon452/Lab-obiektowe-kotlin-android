...
internal class AnimalTest {
    ...
    fun move() {
        ...
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(5, 2)), true)
        myAnimal.move(LEFT)
        assertEquals(myAnimal.isAt(Vector2d(5, 2)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(5, 3)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(5, 4)), true)
        myAnimal.move(RIGHT)
        assertEquals(myAnimal.isAt(Vector2d(5, 4)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(6, 4)), true)
        myAnimal.move(RIGHT)
        assertEquals(myAnimal.isAt(Vector2d(6, 4)), true)
        myAnimal.move(RIGHT)
        assertEquals(myAnimal.isAt(Vector2d(6, 4)), true)
        ...
        assertEquals(myAnimal.isAt(Vector2d(1, 4)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(1, 3)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(1, 2)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(1, 1)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(1, 0)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(1, 0)), true)
        myAnimal.move(FORWARD)
        assertEquals(myAnimal.isAt(Vector2d(0, 0)), false)
